<?php
//condb
$con= mysqli_connect("localhost","root","1234","carousel") or die("Error: " . mysqli_error($con));
            ...
            <div class="carousel-inner">
              ...
              <div class="carousel-item <?php echo $actives;?>">
                <a href="https://www.youtube.com/c/devbanban" target="_blank">
                  <img style="height:520px;" class="d-block w-100" src="<?php echo $row['Image_path'];?>" alt="devbanban">
                </a>
              </div>
              <?php 
              $i++;}
