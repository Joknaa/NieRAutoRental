...
if (!isset($_SESSION["ID_User"]) || !isset($_SESSION["UserType"])) {
    ...
    if ($UserType != "client") {
        header("refresh:1;url=Home.php");
        echo "This place is private, only for the Clients ! Redirecting to the Home page in a Sec ..";
    } else {
        ?>
        <!DOCTYPE html>
        <html>
        ...
        <section class="features10 cid-sz72N5KVZr" id="features11-1">
            ...
            <div class="container">
                <div class="title">
                    <h3 class="mbr-section-title mbr-fonts-style mb-4 display-2"><strong>Pending Requests </strong></h3>
                </div>
        ...
        <section
            style="font-family: -apple-system; font-size:12px; padding: 0; align-items: center; display: flex;"></section>
