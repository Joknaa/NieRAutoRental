...
if (!isset($_POST["submit_ProfilePreview"])) {
                ...
                <div style="width: 100%" class="col-md-8">
                    <div class="col-lg-12">
                        <div style="margin-bottom:10px;" class="card g-mb-30 card-comment">
                            ...
                            <div style="height:50px;font-family: 'Open Sans';background-image: linear-gradient(120deg, #fdfbfb 0%, #ebedee 100%);"
                    ...
                    <?php
                    try {
                        $commentIDs_Result = SQL_GetProfileCommentID($_POST["ID_User"]);
